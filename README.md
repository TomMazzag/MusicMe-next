...
To start this project you will need access to the backend repo (private) <br> Make sure you have
...
- Users can discover new genres, new genre promoters as well as see what friends are liking
